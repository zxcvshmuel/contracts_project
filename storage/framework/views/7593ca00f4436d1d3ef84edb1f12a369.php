...
} elseif ($_instance->childHasBeenRendered('mWAVqdG')) {
    $componentId = $_instance->getRenderedChildComponentId('mWAVqdG');
    $componentTag = $_instance->getRenderedChildComponentTagName('mWAVqdG');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('mWAVqdG');
} else {
    $response = \Livewire\Livewire::mount('filament.core.global-search');
    $html = $response->html();
    $_instance->logRenderedChild('mWAVqdG', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('KViXlv9')) {
    $componentId = $_instance->getRenderedChildComponentId('KViXlv9');
    $componentTag = $_instance->getRenderedChildComponentTagName('KViXlv9');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('KViXlv9');
} else {
    $response = \Livewire\Livewire::mount('filament.core.notifications');
    $html = $response->html();
    $_instance->logRenderedChild('KViXlv9', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH /home/sdevcoi1/public_html/contracts/resources/views/vendor/filament/components/topbar.blade.php ENDPATH**/ ?>