...
} elseif ($_instance->childHasBeenRendered('l1202980018-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l1202980018-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1202980018-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1202980018-0');
} else {
    $response = \Livewire\Livewire::mount('notifications');
    $html = $response->html();
    $_instance->logRenderedChild('l1202980018-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>

</div>
<?php /**PATH /home/sdevcoi1/public_html/contracts/resources/views/vendor/filament-breezy/components/auth-card.blade.php ENDPATH**/ ?>