...
<?php $component->withAttributes(['class' => 'mt-8']); ?>
         ...
         <?php $__env->slot('title', null, []); ?> 
            <?php echo e(__('default.profile.personal_info.heading')); ?>

         <?php $__env->endSlot(); ?>

         <?php $__env->slot('description', null, []); ?> 
            <?php echo e(__('default.profile.personal_info.subheading')); ?>
...
<?php $component->withAttributes([]); ?>
                ...
                <?php echo e($this->updateProfileForm); ?>
...
<?php $component->withAttributes(['type' => 'submit']); ?>
                            <?php echo e(__('default.profile.personal_info.submit.label')); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                <?php echo e($isDownloadDisabled = false); ?>


                <?php echo e($this->updateCompanyProfileForm); ?>
...
<?php endif; ?>
    ...
    <?php if (isset($component)) { $__componentOriginal71c6471fa76ce19017edc287b6f4508c = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament-breezy::components.grid-section','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('filament-breezy::grid-section'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
...
<?php $component->withAttributes([]); ?>
         ...
         <?php $__env->slot('title', null, []); ?> 
            <?php echo e(__('default.profile.password.heading')); ?>

         <?php $__env->endSlot(); ?>

         <?php $__env->slot('description', null, []); ?> 
            <?php echo e(__('default.profile.password.subheading')); ?>
...
<?php $component->withAttributes([]); ?>
                ...
                <?php echo e($this->updatePasswordForm); ?>
...
<?php endif; ?>
    ...
    <?php if(config('filament-breezy.enable_2fa')): ?>
        <?php if (isset($component)) { $__componentOriginal71c6471fa76ce19017edc287b6f4508c = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.hr','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('filament::hr'); ?>
<?php if ($component->shouldRender()): ?>
...
<?php $component->withAttributes(['class' => 'mt-8']); ?>
             ...
             <?php $__env->slot('title', null, []); ?> 
                <?php echo e(__('filament-breezy::default.profile.2fa.title')); ?>

             <?php $__env->endSlot(); ?>

             <?php $__env->slot('description', null, []); ?> 
                <?php echo e(__('filament-breezy::default.profile.2fa.description')); ?>
...
<?php $component->withAttributes(['class' => 'col-span-2 sm:col-span-1 mt-5 md:mt-0']); ?>
                <?php if($this->user->has_enabled_two_factor): ?>
                    ...
                    <?php if($this->user->has_confirmed_two_factor): ?>
                        <p class="text-lg font-medium text-gray-900 dark:text-white"><?php echo e(__('filament-breezy::default.profile.2fa.enabled.title')); ?></p>
                        <?php echo e(__('filament-breezy::default.profile.2fa.enabled.description') ?? __('filament-breezy::default.profile.2fa.enabled.store_codes')); ?>

                    <?php else: ?>
                        <p class="text-lg font-medium text-gray-900 dark:text-white"><?php echo e(__('filament-breezy::default.profile.2fa.finish_enabling.title')); ?></p>
                        <?php echo e(__('filament-breezy::default.profile.2fa.finish_enabling.description')); ?>
                    ...
                    <div class="mt-2">
                        ...
                        <p><?php echo e(__('filament-breezy::default.profile.2fa.setup_key')); ?> <?php echo e(decrypt($this->user->two_factor_secret)); ?></p>
                    </div>

                    <?php if($this->showing_two_factor_recovery_codes): ?>
                        <hr class="my-3"/>
                        <p><?php echo e(__('filament-breezy::default.profile.2fa.enabled.store_codes')); ?></p>
                        <div class="space-y-2">
                ...
                <?php else: ?>
                    ...
                    <p class="text-lg font-medium text-gray-900 dark:text-white"><?php echo e(__('filament-breezy::default.profile.2fa.not_enabled.title')); ?></p>
                    <?php echo e(__('filament-breezy::default.profile.2fa.not_enabled.description')); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['type' => 'submit']); ?>
                                        <?php echo e(__('filament-breezy::default.profile.2fa.actions.confirm_finish')); ?>
...
<?php $component->withAttributes(['color' => 'secondary','wire:click' => 'disableTwoFactor']); ?>
                                        <?php echo e(__('filament-breezy::default.profile.2fa.actions.cancel_setup')); ?>
...
<?php endif; ?>
    ...
    <?php if(config('filament-breezy.enable_sanctum')): ?>
        <?php if (isset($component)) { $__componentOriginal71c6471fa76ce19017edc287b6f4508c = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.hr','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('filament::hr'); ?>
<?php if ($component->shouldRender()): ?>
...
<?php $component->withAttributes(['class' => 'mt-8']); ?>
             ...
             <?php $__env->slot('title', null, []); ?> 
                <?php echo e(__('filament-breezy::default.profile.sanctum.title')); ?>

             <?php $__env->endSlot(); ?>

             <?php $__env->slot('description', null, []); ?> 
                <?php echo e(__('filament-breezy::default.profile.sanctum.description')); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                        <?php if($plain_text_token): ?>
                            <input type="text" disabled class="<?php echo \Illuminate\Support\Arr::toCssClasses(['w-full py-1 px-3 rounded-lg bg-gray-100 border-gray-200',' dark:bg-gray-900 dark:border-gray-700'=>config('filament.dark_mode')]) ?>" name="plain_text_token" value="<?php echo e($plain_text_token); ?>" />
                        <?php endif; ?>

                        <?php echo e($this->createApiTokenForm); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['type' => 'submit']); ?>
                                <?php echo e(__('filament-breezy::default.profile.sanctum.create.submit.label')); ?>
...
<?php endif; ?>
                ...
                <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount(\JeffGreco13\FilamentBreezy\Http\Livewire\BreezySanctumTokens::class)->html();
} elseif ($_instance->childHasBeenRendered('l3317749859-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l3317749859-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3317749859-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3317749859-0');
} else {
    $response = \Livewire\Livewire::mount(\JeffGreco13\FilamentBreezy\Http\Livewire\BreezySanctumTokens::class);
    $html = $response->html();
    $_instance->logRenderedChild('l3317749859-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php unset($__componentOriginal71c6471fa76ce19017edc287b6f4508c); ?>
<?php endif; ?>
<?php /**PATH /home/sdevcoi1/public_html/contracts/resources/views/filament/pages/my-profile.blade.php ENDPATH**/ ?>