...
} elseif ($_instance->childHasBeenRendered('l1903935270-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l1903935270-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1903935270-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1903935270-0');
} else {
    $response = \Livewire\Livewire::mount('notifications');
    $html = $response->html();
    $_instance->logRenderedChild('l1903935270-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>

</div>
<?php /**PATH /var/www/html/contracts/vendor/jeffgreco13/filament-breezy/src/../resources/views/components/auth-card.blade.php ENDPATH**/ ?>