...
<?php endif; ?>
    ...
    <div class="text-center">
        <a class="text-primary-600 hover:text-primary-700" href="<?php echo e(route(config('filament-breezy.route_group_prefix').'password.request')); ?>">שכחתי סיסמא</a>
    </div>
 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal71c6471fa76ce19017edc287b6f4508c)): ?>
...
<?php unset($__componentOriginal71c6471fa76ce19017edc287b6f4508c); ?>
<?php endif; ?>
<?php /**PATH /home/sdevcoi1/public_html/contracts/resources/views/vendor/filament-breezy/login.blade.php ENDPATH**/ ?>