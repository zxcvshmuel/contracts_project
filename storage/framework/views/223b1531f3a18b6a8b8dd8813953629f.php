...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.button','data' => ['form' => $getForm(),'type' => $canSubmitForm() ? 'submit' : 'button','tag' => $action->getUrl() ? 'a' : 'button','wire:click' => $wireClickAction,'href' => $action->isEnabled() ? $action->getUrl() : null,'target' => $action->shouldOpenUrlInNewTab() ? '_blank' : null,'xOn:click' => $canCancelAction() ? 'close()' : null,'color' => $getColor(),'outlined' => $isOutlined(),'icon' => $getIcon(),'iconPosition' => $getIconPosition(),'size' => $getSize(),'attributes' => $getExtraAttributeBag(),'class' => 'filament-page-modal-button-action']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php /**PATH /home/sdevcoi1/public_html/contracts/resources/views/vendor/filament/pages/actions/modal/actions/button-action.blade.php ENDPATH**/ ?>