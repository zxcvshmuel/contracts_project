...
} elseif ($_instance->childHasBeenRendered('rpPXXGR')) {
    $componentId = $_instance->getRenderedChildComponentId('rpPXXGR');
    $componentTag = $_instance->getRenderedChildComponentTagName('rpPXXGR');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('rpPXXGR');
} else {
    $response = \Livewire\Livewire::mount('notifications');
    $html = $response->html();
    $_instance->logRenderedChild('rpPXXGR', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
 <?php echo $__env->renderComponent(); ?>
...
<?php unset($__componentOriginal71c6471fa76ce19017edc287b6f4508c); ?>
<?php endif; ?>
<?php /**PATH /var/www/html/contracts/resources/views/vendor/filament/components/layouts/card.blade.php ENDPATH**/ ?>