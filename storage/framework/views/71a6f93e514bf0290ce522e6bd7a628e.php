...
} elseif ($_instance->childHasBeenRendered('uStFaCr')) {
    $componentId = $_instance->getRenderedChildComponentId('uStFaCr');
    $componentTag = $_instance->getRenderedChildComponentTagName('uStFaCr');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('uStFaCr');
} else {
    $response = \Livewire\Livewire::mount('welcome');
    $html = $response->html();
    $_instance->logRenderedChild('uStFaCr', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
...
<?php endif; ?>
<?php /**PATH /var/www/html/contracts/resources/views/components/layouts/welcome.blade.php ENDPATH**/ ?>